/* -- Done
 * Move Drive Stop call out of public void loop() {
 * added line 79
 * getConfidence changed slightly
 * No more thread sleeping in the drive function --> Done by Miles
 *
 
 * -- Program Summary
 * Starts a timer to stop all bot functions at the 29.9 second mark
 * Grabs Rings
 * 180
 * shoots rings
 
 * -- To-do
 * Copy over to all files
 * Look over the drive function and test things such as ABS
 * 
 */ 
...
@Autonomous(name = "AutoShawtyBI_Calvin", group = "Best Opmodes (20-21)")

public class AutoShawtyBI_Calvin extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    if (opModeIsActive()) {
      while (opModeIsActive()) {
        t.schedule(sm, 29900);
        //telemetryThread.submit(task); // runs telemetry class on RUN
        //taskUpdate();                 // function to update telemetry
        //getConfidenceVals();
  ...
  // azimuth = direction || getDirection based off degrees
